/* The following code was generated by JFlex 1.4.3 on 13-4-12 ÏÂÎç1:12 */
 ...
 * on 13-4-12 ÏÂÎç1:12 from the specification file
...
public static void main(String [] args) throws IOException
{
	...
	for(Expression expr: exprList) System.out.println(expr.getClass().getName() + ": " + expr.toString());
}
  ...
  public Object yylex() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 2: 
          { System.out.println("intvalue"); exprList.add(new IntValue(yytext()));
          }
        case 5: break;
        case 1: 
          { charCount++;
